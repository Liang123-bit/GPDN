...
#         self.log("best_val_psnr", self.best_psnr, on_epoch=True, logger=True, sync_dist=True)
#         self.log("val_psnr", val_psnr, on_epoch=True, logger=True, sync_dist=True)
#         self.log("\n 1",1.1, on_epoch=True, logger=True, sync_dist=True, prog_bar=True)
        self.psnr.reset()
        ...
        print("\nval_PSNR: {:^20} Best val PSNR: {:^20}".format(val_psnr, self.best_psnr))
        print("val_SSIM: {:^20} Best_val_SSIM: {:^20}\n".format(val_ssim, self.best_ssim))
#         self.log("best_val_ssim", self.best_ssim, on_epoch=True, logger=True, sync_dist=True)
#         self.log("val_ssim", val_ssim, on_epoch=True, logger=True, sync_dist=True)
        self.ssim.reset()
